                ...
                <div class="main_container margin_30">
                    <div class="details_row">
                        ...
                        <div class="details_col_9" v-if="currentPromo">
                            ...
                            <img v-if="currentPromo.image_url" v-lazy="currentPromo.image_url" :alt="currentPromo.name" class="margin_20 img_max"/>
                            ...
                            <hr>
                            <social-sharing v-if="currentPromo" :url="shareURL(currentPromo.slug)" :title="currentPromo.name" :description="currentPromo.body" :quote="truncate(currentPromo.body)" :media="currentPromo.image_url" inline-template>
