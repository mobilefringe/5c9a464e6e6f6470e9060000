<template>
    <div> <!-- without an outer container div this component template will not render -->
        ...
        <div style="display: none;" id="hidden-fb">
            <div class="fb-page" :data-href="dataHref" data-tabs="timeline" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote :cite="dataHref" class="fb-xfbml-parse-ignore"><a :href="dataHref">{{linkText}}</a></blockquote></div>
        </div>
    </div>
</template>
