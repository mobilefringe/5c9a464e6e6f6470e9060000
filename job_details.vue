...
<script>
    define(["Vue", "vuex", "moment", "moment-timezone", "vue-moment", "vue!inside_banner.vue", "vue!side_image.vue", "vue-social-sharing", "json!site.json"], function(Vue, Vuex, moment, tz, VueMoment, insideBanner, sideImage, SocialSharing, site) {
