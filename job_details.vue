...
<script>
    define(["Vue", "vuex", "moment", "moment-timezone", "vue!inside_banner.vue", "vue!side_image.vue", "vue-social-sharing", "json!site.json"], function(Vue, Vuex, moment, tz, insideBanner, sideImage, SocialSharing, site) {
