<template>
    <div class="inside_header_background" v-if="pageBanner" :style="{ background: 'linear-gradient(0deg, rgba(138,37,26,0.5), rgba(138,37,26,0.5)), url(' + pageBanner.image_url + ') center center' }">
